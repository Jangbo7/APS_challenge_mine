...
class Config:
    ...
    # 频率通道处理
    USE_FREQ_CHANNELS = True  # 是否使用频率通道(高频+低频)特征，如果为True输出5通道，为False输出3通道
    ...
    # 模型类型选择
    # 支持: 'efficientnetv2_s', 'efficientnetv2_m', 'efficientnetv2_l', 'convnext_tiny', 'convnext_small', 'convnext_base', 'convnext_large'
